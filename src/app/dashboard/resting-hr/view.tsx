    ...
    <div style={{ position: "relative", width: size, height: size, margin: "0 auto" }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        <div style={{ display: "inline-flex", alignItems: "baseline", gap: 7, lineHeight: 1 }}>
          <span style={{ fontSize: 58, fontWeight: 800, letterSpacing: "-2px", color: "var(--nura-text-primary)", textShadow: `0 0 18px rgba(${RING_GLOW},0.35)` }}>{shownNum}</span>
