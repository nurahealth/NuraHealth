...
// ── Active Energy card ─────────────────────────────────────────────────────────
// Mini goal ring (fill = kcal / move goal) with the kcal count-up
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 9, padding: "10px 0" }}>
        <ActiveEnergyRing kcal={kcal} goal={goal} size={118} stroke={10} fillMs={1300} color={paint} />
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 7, marginTop: "auto" }}>
        <span className="nura-note-ink" style={{ fontFamily: SANS, fontSize: 12, fontWeight: 600, color: paint.hex }}>{note}</span>
        <span style={{
